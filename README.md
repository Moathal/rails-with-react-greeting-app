...
> This is a project where i implement React and rails both in project.
...
```sh
  cd my-blog
  git clone git@github.com:aamirkhan2478/rails-react-app.git
```
...
Feel free to check the [issues page](https://github.com/aamirkhan2478/rails-react-app/issues).
